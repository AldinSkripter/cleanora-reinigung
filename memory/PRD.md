...
- Admin-Tab „Medien": Share-Bild (1200×630, JPG/PNG/WebP ≤2 MB) + Favicon (PNG/SVG/ICO ≤512 KB) hochladen/ersetzen/löschen; Persistenz in backend/uploads; öffentliche Endpunkte /api/media/share-image + /api/media/favicon mit Fallback (og-default.jpg / favicon.svg); Favicon-Swap per JS im Browser (Crawler-irrelevant), OG-Bild-URL stabil über Backend-Endpunkt.
