            ...
            <Reveal key={s.slug} delay={0.05}>
              <article className="grid items-center gap-10 lg:grid-cols-12">
                ...
                <div className={`lg:col-span-6 ${i % 2 === 1 ? "lg:order-1 lg:col-start-1" : "lg:col-start-7"}`}>
                  <span className="text-xs font-medium tracking-[0.25em] text-precision/40">
                  ...
                  <Link
                    ...
                    className="group mt-6 inline-flex items-center gap-2 border-b border-precision pb-1 text-sm font-medium text-precision transition-colors duration-300 hover:text-precision/60"
                  >
                    Mehr erfahren
